// Vercel Edge Function — lista de "compras recientes" (solo nombres) de un hogar compartido
...
export default async function handler(req: Request): Promise<Response> {
  ...
  if (req.method === 'GET') {
    ...
    const items = await redis.get<RecentPurchaseItem[]>(`household:${code}:purchases`);
